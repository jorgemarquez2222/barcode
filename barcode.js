	...
	function init() {
		...
		if (navigator.getUserMedia) {
			navigator.getUserMedia({audio: false, video: true}, function(stream) {
				...
				// // elements.video.src = window.URL.createObjectURL(new Blob(binaryData, {type: "application/zip"}));
				// elements.video.src=window.URL.createObjectURL(new Blob(binaryData, {type: "application/video"}));
				// elements.video.play();
